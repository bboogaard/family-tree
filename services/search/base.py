...
class SearchService(ABC):
    ...
    def search(self, search_request: dataclass, order_by: str = '') -> QuerySet:
        ...
        queryset = self.get_queryset(search_request, order_by)
        return queryset

    def get_queryset(self, search_request: dataclass, order_by: str) -> QuerySet:
